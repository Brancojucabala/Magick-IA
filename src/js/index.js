...
botaoFiltrar.addEventListener('click', function () {
    ...
    // passo 4 - para cada carta, verificar se ela deve ser mostrada ou escondida baseada nos filtros
    ...
    cartas.forEach(function(carta){
        ...
        const cartaNaoBaterComFiltroDeCategoria = categoriaSelecionada.toLowerCase() !== categoriaCarta.toLowerCase();

        if(temFiltroDeCategoria && cartaNaoBaterComFiltroDeCategoria){
            mostrarCarta = false
        }
